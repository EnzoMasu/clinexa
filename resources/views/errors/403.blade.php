@php($mensaje = $exception->getMessage() ?: 'No tenés permiso para acceder a esta sección.')
            ...
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-8 text-center space-y-4">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Si necesitás acceso, pedile a un administrador que revise los permisos de tu perfil.
                    </p>
